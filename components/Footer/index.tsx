              ...
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                <div>
                  <Link
                    ...
                    className="rounded-md bg-[#00b42e] py-4 px-8 text-base font-semibold text-white duration-300 ease-in-out hover:bg-primary/80"
                  >
                    Download Brochure and Portfolio <DownloadIcon />
                  </Link>
                </div>
